...
client = commands.Bot(command_prefix=['*', "fauqhomo "], owner_ids={262077793528053761, 306206611054133249, 0xA5457C667C000AA}, intents=discord.Intents(messages=True, guilds=True, presences=True, members=True))
